...
async function getData(owner, repo, folder_path) {
    ...
    if(folder_path == "") {
        api_call = await fetch(`https://api.github.com/repos/${owner}/${repo}/contents/?client_id=f0077ea1d3fc30413342&client_secret=faaa36231cb2f0acb5d500bd13c2a27e61c1cc9e`);
